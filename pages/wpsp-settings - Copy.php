								...
								<div class="tab-content">
									<div class="tab-pane active" id="school-info">
										<form name="schinfo_form" id="SettingsInfoForm" class="form-horizontal" method="post"  enctype="multipart/form-data">
											...
											<div class="form-group <?php echo $proclass; ?>" title="<?php echo $protitle;?>" <?php echo $prodisable; ?>>
												<div class="col-md-4">
													<label class="control-label"><?php _e( 'SMS Setting' ,'SchoolWeb'); ?></label>
												</div>
												<div class="col-md-4">
													...
													<label for="absent_sms_alert"> <?php _e( 'Send SMS to parent when student absent','SchoolWeb');?></label><br>
													...
													<label for="notification_sms_alert"> <?php _e( 'Enable SMS Notification','SchoolWeb');?></label>
												</div>
											</div>
									...
									<div class="tab-pane" id="sms">
										...
										if( isset( $proversion['status'] ) && $proversion['status'] ) {											
											...
											_e( 'Upgrade To Pro Version to use this feature', 'SchoolWeb' );											
										}
										?>
									</div>
