...
wpsp_header();
	if( is_user_logged_in() ) {
		...
		if($current_user_role=='administrator' || $current_user_role=='editor' ) {
			...
			else if( isset( $_GET['tab'] ) && $_GET['tab'] == 'concession' ) {
				$label	=	__( 'Concession', 'SchoolWeb');
				$filename	=	WPSP_PLUGIN_PATH .'includes/wpsp-concession.php';
			}
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li><a href="<?php echo site_url('sch-fee-man'); ?>"><?php _e( 'Fees Management', 'SchoolWeb'); ?></a></li>
