...
//Inquiry Module
	if( is_user_logged_in() ) {
		...
		if($current_user_role=='administrator' || $current_user_role=='editor' ) {
			...
			wpsp_sidebar();
			wpsp_body_start();
			$filename	=	WPSP_PLUGIN_PATH .'includes/wpsp-visitorFormAndList.php';
			$label = "Enquiries And Visitors"	?>
			<section class="content-header">
				<h1><?php echo $label; ?></h1>
				<ol class="breadcrumb">
					<li><a href="<?php echo site_url('sch-dashboard'); ?> "><i class="fa fa-dashboard"></i><?php _e( 'Dashboard', 'SchoolWeb'); ?> </a></li>
					<li><a href="<?php echo site_url('sch-enquiry'); ?>"><?php _e( 'Enquiry', 'SchoolWeb'); ?></a></li>
				</ol>
			</section>
			<?php
