...
if( 'POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['noh']) && $_POST['noh'] != '') {
	...
	$wpsp_class_id = esc_attr($_POST['wpsp_class_name']);
	$noh = esc_attr($_POST['noh']);
...
if (($skip_hours===TRUE)||('POST' == $_SERVER['REQUEST_METHOD'] && $_POST['sessions_template'] == 'available' && $_POST['template_class'] != '') || ('POST' == $_SERVER['REQUEST_METHOD'] && isset($_POST['last-step']) && $_POST['last-step'] == 'submit')) 
{
	$tt_table = $wpdb->prefix . "wpsp_timetable";
	$subject_table = $wpdb->prefix . "wpsp_subject";
	$h_table = $wpdb->prefix . "wpsp_workinghours";
	$class_id = $_POST['wpsp_class_name'];
	$sess_template = $_POST['sessions_template'];
	?>
	<div class="box box-info">
		<div class="box-header">
		...
		<div class="box-body">
			...
			if ($sess_template == 'new') {
				...
				if($skip_hours==TRUE){
					...
					$template_class_id = $_POST['template_class'];
				}
			...
			if ($error == 0) {
				...
				<div class="row"> 
								<div class="col-md-12">
	<label>
					Class : <?php echo wpsp_GetClassName($_POST['wpsp_class_name']); ?>	</label>
